...
#    Updated: 2022/06/21 17:18:46 by nsamoilo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	main.c char_array_manipulation.c parsing.c validation.c testing.c sorting.c check_duplicates.c room.c search.c
